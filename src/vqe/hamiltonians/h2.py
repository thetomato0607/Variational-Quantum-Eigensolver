...
def get_h2_hamiltonian(distance: float):
    ...
    Returns: (qubit_operator, nuclear_repulsion_energy, num_particles, num_orbitals)
    """
    driver = PySCFDriver(
    ...
    return qubit_op, problem.nuclear_repulsion_energy, problem.num_particles, problem.num_spatial_orbitals